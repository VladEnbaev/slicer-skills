...
Use Slicer as a workflow layer for coding-agent work. The skills are plain instructions, and the same behavior should work across agent harnesses.

Before starting non-trivial engineering work, read the relevant Slicer skill and follow its rules. Prefer:
...
@./skills/slicer-checkpoints/SKILL.md
@./skills/slicer-planning/SKILL.md
@./skills/slicer-execution/SKILL.md
@./skills/slicer-debugging/SKILL.md
